...
config :hello_phx, HelloPhxWeb.Endpoint,
  ...
  live_view: [signing_salt: "MwEJxli0"]
...
config :esbuild,
  ...
  hello_phx: [
    args:
      ~w(js/app.js --bundle --target=es2017 --loader:.js=jsx --outdir=../priv/static/assets --external:/fonts/* --external:/images/* --external:*.woff --external:*.woff2),
